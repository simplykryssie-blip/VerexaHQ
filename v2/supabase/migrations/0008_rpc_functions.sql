...
-- Callable RPCs for tenant provisioning, membership management, and feature
-- flag toggling. Each does its own permission check internally so it is safe
-- to expose directly to authenticated clients via PostgREST/supabase-js.

-- ============================================================================
-- create_workspace: the only sanctioned way to provision a new tenant.
-- Creates the workspace, makes the caller its owner, seeds default branding
-- and enables every "core" feature flag.
-- ============================================================================
...
-- ============================================================================
-- get_my_workspaces: workspaces the caller belongs to, with their role.
-- Security invoker: relies on existing RLS, which already permits self-access.
-- ============================================================================
...
-- ============================================================================
-- invite_workspace_user / accept_workspace_invitation / revoke_workspace_user
-- Caller must already have provisioned the target auth.users row (e.g. via
-- supabase.auth.admin.inviteUserByEmail from a trusted server context) before
-- calling invite_workspace_user with that user's id.
-- ============================================================================
...
-- ============================================================================
-- set_feature_flag: admin toggles a module on/off for their workspace.
-- ============================================================================
