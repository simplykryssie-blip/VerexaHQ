...
-- Feature flag catalog + per-workspace enablement, so future modules
-- (bookkeeping, payroll, business formation, tax planning, resolution,
-- advisory) can be switched on per tenant without redesigning the schema.
