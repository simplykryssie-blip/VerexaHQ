-- Revision Sprint -- Phase 2.5: Security & Compliance Framework
-- New module. Reuses user_profiles (Phase 0) for per-user security state
-- rather than a parallel table, and the existing audit_log/audit_trigger_fn
-- pattern for tracking policy changes.
...
-- ============================================================================
-- workspace_security_policies: password/session/lockout/MFA policy, one row
-- per workspace. Every threshold is configurable, never hardcoded in app
-- logic.
-- ============================================================================
...
-- ============================================================================
-- login_history: append-only. Populated by a server-side auth hook/Edge
-- Function via record_login_attempt() (service-role only -- not directly
-- callable by clients, since a client-reported "success" flag can't be
-- trusted).
-- ============================================================================
...
-- ============================================================================
-- trusted_devices: self-service, no workspace scoping -- a device belongs
-- to the person, not the firm.
-- ============================================================================
...
-- ============================================================================
-- consent_records: append-only. Either a workspace_user consenting for
-- themselves, or staff recording a client's consent (portal invitation
-- acceptance, e-signature consent) on the client's behalf until the client
-- portal has its own auth (a later phase).
-- ============================================================================
...
-- ============================================================================
-- workspace_retention_policies: workspace-configurable, never hardcoded.
-- Null = keep forever.
-- ============================================================================
