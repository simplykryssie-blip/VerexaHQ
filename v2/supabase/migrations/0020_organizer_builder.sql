-- Phase 2: Firm Configuration Engine -- Organizer Builder
-- Drag-and-drop organizer templates. workspace_id NULL = Verexa system
-- template; NOT NULL = a workspace's own editable copy.
