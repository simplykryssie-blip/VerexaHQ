-- Phase 2: Firm Configuration Engine -- Verexa System Blueprint Library
-- Six read-only (workspace_id null) system blueprints: Individual Tax
-- Preparation, Business Tax Preparation, Amended Return, Extension Filing,
-- IRS Notice Response, and Tax Planning. Every referenced row below is a
-- system template (workspace_id null); firms only ever get independent
-- copies via apply_blueprint()/duplicate_config_object().
...
-- ============================================================================
-- BLUEPRINT 1: Individual Tax Preparation (flagship, full depth)
-- ============================================================================
...
-- ============================================================================
-- BLUEPRINT 2: Business Tax Preparation
-- ============================================================================
insert into public.processes (name, slug, description, status) values
