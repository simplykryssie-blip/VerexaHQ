-- Phase 2: Firm Configuration Engine -- Pipelines
-- A Pipeline is the kanban-style board Cases are tracked through (distinct
-- from a Process, which defines the checklist of work). workspace_id NULL =
-- Verexa system pipeline template; NOT NULL = a workspace's own copy.
