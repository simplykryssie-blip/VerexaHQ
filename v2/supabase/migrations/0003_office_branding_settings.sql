...
-- Office locations, per-workspace branding, and flexible key/value settings.
...
-- ============================================================================
-- branding: one row per workspace. Drives portal theming, login screens, and
-- outbound communication headers.
-- ============================================================================
...
-- ============================================================================
-- system_settings: flexible per-workspace key/value configuration store so
-- future phases can add settings without new columns or migrations.
-- ============================================================================
