...
-- Audit trail, human-facing activity feed, and outbound notification queue.

-- ============================================================================
-- audit_log: immutable security/compliance trail. Populated exclusively by
-- the audit_trigger_fn() trigger (runs as table owner, bypassing RLS), never
-- by direct client insert, so the trail cannot be forged or gapped.
-- ============================================================================
...
-- ============================================================================
-- activity_log: human-readable timeline feed for the UI (distinct from the
-- security-focused audit_log). Clients may write their own entries.
-- ============================================================================
...
-- ============================================================================
-- notification_queue: outbound jobs for email/SMS/portal/push. Phase 0 only
-- defines the schema; a Phase 5 Edge Function/worker drains it.
-- ============================================================================
