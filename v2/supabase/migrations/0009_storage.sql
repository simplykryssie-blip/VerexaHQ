...
-- Storage bucket for branding assets (logos, favicons). Public read so the
-- login screen and client portal can render them unauthenticated; write
-- access restricted to that workspace's admins. Objects are stored under
-- "<workspace_id>/..." so the folder prefix doubles as the tenant boundary.
