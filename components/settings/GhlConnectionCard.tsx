    ...
    <div className="rounded-2xl border border-border bg-surface shadow-soft p-5">
      ...
      {!isConnected && (
        <p className="mt-2 text-xs text-muted">
          In GHL: Settings &gt; Private Integrations &gt; Create New Integration (scope: View Contacts -- add View Notes/Tasks/Appointments and
          Conversations too if you plan to import those as well). Location ID is under Settings &gt; Business Profile.
        </p>
      )}
