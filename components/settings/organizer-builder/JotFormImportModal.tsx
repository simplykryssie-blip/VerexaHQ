        ...
        <div className="mt-3 flex gap-2 rounded-lg border border-amber-300 bg-amber-50 p-3 text-xs text-amber-900">
          ...
          <div>
            ...
            <p className="mt-1">
              ...
              flags, field order, headings, text blocks, and page breaks all transfer.
            </p>
            <p className="mt-1">
              <strong>Conditional show/hide logic, branching, calculations, and pricing are not imported.</strong> You&apos;ll need
              to rebuild any of those manually afterward in the field&apos;s Conditional Logic panel. Field types JotForm supports
              that we don&apos;t (matrix tables, custom widgets, etc.) come in as a plain text field instead, and will be flagged
              after import so you can fix them.
            </p>
          </div>
        </div>
