...
export type WebsiteCard = { id: string; name: string; slug: string; status: string; page_count: number };
...
export function WebsiteLibrary({
  ...
  return (
    <div>
      ...
      <div className="mt-4">
        {websites.length === 0 ? (
          <EmptyState message="No websites yet -- create one to start building your public site." />
        ) : (
