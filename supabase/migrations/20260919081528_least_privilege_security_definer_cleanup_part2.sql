...
--
-- Second half of the 2026-09-19 least-privilege pass: revokes anon AND
-- authenticated execute on the 86-function "internal/service_role-only"
-- Group B list (matches the p18 regression test's v_group_b array exactly).
-- These are trigger functions and internal helpers that should never be
-- directly callable via PostgREST by any client-facing role.
--
