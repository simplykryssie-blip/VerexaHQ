...
-- 2026-09-17 (recorded version 20260917132316, name
-- operational_gate_audit_batch5_pipelines_automations in
...
-- all 12 functions below directly against production; every one still
-- contains the is_workspace_operational gate added here. Zero drift --
-- including advance_pipeline_stage, whose only later main-tracked touch
-- (20260927060000_firm_scoped_automation_actions.sql) does not itself carry
-- the gate; production's live function (the real source of truth) already
-- has both changes merged, so recovering this file restores git's copy of
-- the gate without conflicting with that later, unrelated change.
-- ============================================================================
