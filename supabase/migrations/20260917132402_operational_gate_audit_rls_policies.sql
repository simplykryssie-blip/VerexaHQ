-- Continuation of the archived/permanently_archived operational-gate rollout
-- (see 20260916150000_billing_lifecycle_suspension_enforcement.sql and
-- 20261030000000_operational_gate_rls_closure.sql): adds the
-- is_workspace_operational(workspace_id) AND-clause to write policies on
-- tables the earlier passes didn't cover yet. document_requests_insert/
-- update/delete are intentionally NOT repeated here -- already carried by
-- operational_gate_rls_closure.sql.
