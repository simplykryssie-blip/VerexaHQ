...
declare
  ...
  v_result jsonb;
begin
  select ot.id, ot.name, ot.description, ot.workspace_id, ot.requires_portal_signup, ot.banner_image_url, ot.custom_css, w.name as workspace_name
  into v_template
  ...
  select jsonb_build_object(
    'template', jsonb_build_object('id', v_template.id, 'name', v_template.name, 'description', v_template.description, 'banner_image_url', v_template.banner_image_url, 'custom_css', v_template.custom_css),
