...
comment on table public.dashboards is 'A configurable dashboard layout. role_slug ties it to a system role (owner/admin/ero/ptin_preparer/staff) or the client portal audience for role-aware defaults; null means general-purpose.';
