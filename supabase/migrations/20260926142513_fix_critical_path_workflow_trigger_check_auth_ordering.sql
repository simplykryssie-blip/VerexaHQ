...
-- every other block in this function already uses.
--
-- (Superseded moments later by 20260926142907, which adds a second fix for
-- a follow-on gap this one exposed -- see that file.)
