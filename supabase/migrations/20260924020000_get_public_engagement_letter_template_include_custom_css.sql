...
declare
  v_row record;
begin
  select elt.id, elt.name, elt.body_html, elt.requires_signature, elt.requires_portal_signup, elt.workspace_id, elt.banner_image_url, elt.custom_css,
  ...
  return jsonb_build_object(
    'template', jsonb_build_object('id', v_row.id, 'name', v_row.name, 'body_html', v_row.body_html, 'requires_signature', v_row.requires_signature, 'banner_image_url', v_row.banner_image_url, 'custom_css', v_row.custom_css),
