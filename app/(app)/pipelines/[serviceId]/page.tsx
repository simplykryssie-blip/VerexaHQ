...
export default async function PipelineEditorPage({ params }: { params: { serviceId: string } }) {
  ...
  return (
    <div className="max-w-3xl">
      ...
      <h2 className="mb-1 text-base font-semibold text-ink">{service.name}</h2>
      <p className="mb-6 text-sm text-muted">
        The ordered steps this service&apos;s engagements move through, with the right form or letter attached at the stage that needs
        it. Changes here are global -- they apply to every engagement using this service, not just one client&apos;s.
      </p>
      ...
      <div className="mt-8">
        ...
        <p className="mt-1 text-sm text-muted">
          The folder structure auto-created in every new engagement using this service. Renaming or deleting a folder here only affects
          future engagements -- it never touches folders already created for existing ones.
        </p>
        <div className="mt-3">
