...
export function SettingsNav() {
  ...
  return (
    <nav className="flex gap-4 overflow-x-auto border-b border-border bg-surface px-3 py-2 lg:block lg:w-56 lg:shrink-0 lg:space-y-4 lg:border-b-0 lg:border-r lg:px-3 lg:py-5">
