...
export default async function PlatformAdminPlansPage() {
  ...
  const { data: plans } = await supabase
    ...
    .select(
      "id, slug, name, base_price_cents, included_seats, per_seat_price_cents, email_overage_rate_cents, sms_overage_rate_cents, storage_overage_rate_cents, currency, is_active"
    )
